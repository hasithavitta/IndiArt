...
export const translations: Record<Language, TranslationSet> = {
    en: {
        ...
        step2_title: "Step 2: Add an Image (Optional)",
        step2_subtitle: "A picture is worth a thousand words. You can skip this step if you don't have one.",
        ...
        output_video_title: "Your Short-form Video",
        output_video_loading_title: "Crafting Your Video...",
        ...
        output_video_unsupported: "Your browser does not support the video tag.",
        output_video_download_button: "Download Video",
        output_video_caption_title: "Suggested Caption",
        output_video_audio_title: "Audio Suggestion",
    ...
    hi: {
        ...
        step2_title: "चरण 2: एक छवि जोड़ें (वैकल्पिक)",
        step2_subtitle: "एक तस्वीर हज़ार शब्दों के बराबर होती है। यदि आपके पास कोई नहीं है तो आप इस चरण को छोड़ सकते हैं।",
        ...
        output_video_title: "आपका शॉर्ट-फॉर्म वीडियो",
        output_video_loading_title: "आपका वीडियो तैयार हो रहा है...",
        ...
        output_video_unsupported: "आपका ब्राउज़र वीडियो टैग का समर्थन नहीं करता है।",
        output_video_download_button: "वीडियो डाउनलोड करें",
        output_video_caption_title: "सुझाया गया कैप्शन",
        output_video_audio_title: "ऑडियो सुझाव",
        ...
        content_types: {
            ...
            video: 'शॉर्ट-फॉर्म वीडियो (जैसे, रील, शॉर्ट)',
        },
        languages: {
            en: 'अंग्रेजी (English)',
            hi: 'हिन्दी',
    ...
    bn: {
        ...
        step2_title: "ধাপ ২: একটি ছবি যোগ করুন (ঐচ্ছিক)",
        step2_subtitle: "একটি ছবি হাজার শব্দের সমান। আপনার কাছে না থাকলে আপনি এই ধাপটি এড়িয়ে যেতে পারেন।",
        ...
        output_video_title: "আপনার শর্ট-ফর্ম ভিডিও",
        output_video_loading_title: "আপনার ভিডিও তৈরি হচ্ছে...",
        ...
        output_video_unsupported: "আপনার ব্রাউজার ভিডিও ট্যাগ সমর্থন করে না।",
        output_video_download_button: "ভিডিও ডাউনলোড করুন",
        output_video_caption_title: "প্রস্তাবিত ক্যাপশন",
        output_video_audio_title: "অডিও পরামর্শ",
        ...
        content_types: {
            ...
            video: 'শর্ট-ফর্ম ভিডিও (যেমন, রিল, শর্ট)',
        },
        languages: {
            en: 'ইংরেজি (English)',
            hi: 'হিন্দি (हिन्दी)',
    ...
    ta: {
        ...
        step2_title: "படி 2: ஒரு படத்தைச் சேர்க்கவும் (விருப்பத்தேர்வு)",
        step2_subtitle: "ஒரு படம் ஆயிரம் வார்த்தைகளுக்குச் சமம். உங்களிடம் ஒன்று இல்லையென்றால் இந்த படியைத் தவிர்க்கலாம்.",
        ...
        step2_file_types: "PNG, JPG, GIF 10MB வரை",
        ...
        output_video_title: "உங்கள் குறுகிய வடிவ வீடியோ",
        output_video_loading_title: "உங்கள் வீடியோ உருவாக்கப்படுகிறது...",
        ...
        output_video_unsupported: "உங்கள் உலாவி வீடியோ குறிச்சொல்லை ஆதரிக்கவில்லை.",
        output_video_download_button: "வீடியோவைப் பதிவிறக்கவும்",
        output_video_caption_title: "பரிந்துரைக்கப்பட்ட தலைப்பு",
        output_video_audio_title: "ஆடியோ பரிந்துரை",
        ...
        content_types: {
            ...
            video: 'குறுகிய வடிவ வீடியோ (எ.கா., ரீல், ஷார்ட்)',
        },
        languages: {
            en: 'ஆங்கிலம் (English)',
            hi: 'இந்தி (हिन्दी)',
    ...
    te: {
        ...
        step1_placeholder: "ఉదా., మామిడి చెక్కతో చేతితో చెక్కబడిన చెక్క గిన్నె, సహజమైన తేనెటీగ మైనంతో పాలిష్ చేయబడింది...",
        ...
        step2_title: "దశ 2: చిత్రాన్ని జోడించండి (ఐచ్ఛికం)",
        step2_subtitle: "ఒక చిత్రం వెయ్యి పదాలకు సమానం. మీ దగ్గర ఒకటి లేకపోతే ఈ దశను దాటవేయవచ్చు.",
        ...
        output_video_title: "మీ షార్ట్-ఫారమ్ వీడియో",
        output_video_loading_title: "మీ వీడియోను రూపొందిస్తోంది...",
        ...
        output_video_unsupported: "మీ బ్రౌజర్ వీడియో ట్యాగ్‌కు మద్దతు ఇవ్వదు.",
        output_video_download_button: "వీడియోను డౌన్‌లోడ్ చేయండి",
        output_video_caption_title: "సూచించబడిన శీర్షిక",
        output_video_audio_title: "ఆడియో సూచన",
        ...
        content_types: {
            ...
            video: 'షార్ట్-ఫారమ్ వీడియో (ఉదా., రీల్, షార్ట్)',
        },
        languages: {
            en: 'ఆంగ్లం (English)',
            hi: 'హిందీ (हिन्दी)',
    ...
    mr: {
        ...
        step2_title: "पायरी २: एक प्रतिमा जोडा (पर्यायी)",
        step2_subtitle: "एक चित्र हजार शब्दांच्या बरोबरीचे असते. तुमच्याकडे नसेल तर तुम्ही ही पायरी वगळू शकता.",
        ...
        output_analysis_title: "रणनीतिक विश्लेषण",
        output_video_title: "तुमचा शॉर्ट-फॉर्म व्हिडिओ",
        output_video_loading_title: "तुमचा व्हिडिओ तयार करत आहे...",
        ...
        output_video_unsupported: "तुमचा ब्राउझर व्हिडिओ टॅगला समर्थन देत नाही.",
        output_video_download_button: "व्हिडिओ डाउनलोड करा",
        output_video_caption_title: "सुचवलेले कॅप्शन",
        output_video_audio_title: "ऑडिओ सूचना",
        ...
        content_types: {
            ...
            video: 'शॉर्ट-फॉर्म व्हिडिओ (उदा., रील, शॉर्ट)',
        },
        languages: {
            en: 'इंग्रजी (English)',
            hi: 'हिंदी (हिन्दी)',
